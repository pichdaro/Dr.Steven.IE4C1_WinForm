    ...
    internal class User
    {
        ...
        public static void FetchData(ListView lv)
        {
            try
            {
                ...
                //Declare OleDbCommand and apply command text
                ...
                while (reader.Read())
                {
                    ...
                    {
                        usr.Avata = (byte[])reader.GetValue(6);
                    }
        ...
        public static bool Login(string Username, string Password)
        {
            try
            {
                ...
                MyConfig.logger.Info("User " + MyConfig.activeUser.Username +
                    " loggin to the system.");
                return true;
            }
            catch (Exception ex)
            {
                MyConfig.logger.Error(ex.Message);
        ...
        public static bool SetAvata(int id, byte[] image)
        {
            try
            {
                //Open Connection
                ...
                cmd.Parameters.AddWithValue("Avata", image);
                cmd.Parameters.AddWithValue("id", id);
